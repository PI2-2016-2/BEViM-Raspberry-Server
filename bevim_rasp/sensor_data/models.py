...
class Data(models.Model):
    ...
    x_value = models.DecimalField(max_digits=8, decimal_places=2)
    y_value = models.DecimalField(max_digits=8, decimal_places=2)
    z_value = models.DecimalField(max_digits=8, decimal_places=2)
